...
use crate::mutator::{
    blueprint::LevelDataPipeline, class_info_asset::ClassInfoAssetMutator,
    ...
    PipelineAssetMutator, PipelineResourceMutator, BuildAction, BuildResult,
};
...
impl DataPipeline {
    pub fn new(domain: Arc<DomainStore>, dry_run: bool) -> Self {
    ...
    async fn run_asset_mutator(&self, mutator: &Arc<dyn PipelineAssetMutator>) {
        ...
        for asset in applicable_values {
            ...
            handles.push(tokio::spawn(async move {
                let mut unbuild_result = BuildResult::new();
