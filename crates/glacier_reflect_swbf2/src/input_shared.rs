...
pub struct InputSettings {
    pub input_configuration_asset: InputConfigurationAsset,
...
pub const INPUTSETTINGS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputSettings",
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                ...
                field_type: INPUTCONFIGURATIONASSET_TYPE_INFO,
...
pub const INPUTSETTINGS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputSettings-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputSettings-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const CLIENTINPUTREMOTEPADCHANGEDMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const CLIENTINPUTSETTINGSREFRESHMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const CLIENTINPUTUNCHANGEDINPUTMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTMESSAGESRESETJOYSTICKSIMVALUESMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTMESSAGESKEYBOARDLAYOUTCHANGEDMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTMESSAGESSINGLEINPUTEVENTMESSAGE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub struct InputGraph {
    pub input_action_maps: InputActionMapsData,
    pub combined_input_concept_to_entry_input_action_mappings: InputConceptToEntryInputActionMappings,
    pub concept_ports: Vec<InputConceptNodePorts>,
    pub action_ports: Vec<EntryInputActionNodePorts>,
    pub player_id_port: u32,
}

pub const INPUTGRAPH_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputGraph",
    flags: MemberInfoFlags::new(101),
    module: "InputShared",
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                name: "ConceptPorts",
                flags: MemberInfoFlags::new(144),
                field_type: INPUTCONCEPTNODEPORTS_ARRAY_TYPE_INFO,
                rust_offset: offset_of!(InputGraph, concept_ports),
            },
            FieldInfoData {
                name: "ActionPorts",
                flags: MemberInfoFlags::new(144),
                field_type: ENTRYINPUTACTIONNODEPORTS_ARRAY_TYPE_INFO,
...
pub const INPUTGRAPH_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputGraph-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputGraph-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const ENTRYINPUTACTIONNODEPORTS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const ENTRYINPUTACTIONNODEPORTS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EntryInputActionNodePorts-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EntryInputActionNodePorts-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTCONCEPTNODEPORTS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTCONCEPTNODEPORTS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputConceptNodePorts-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputConceptNodePorts-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTCONCEPTTOENTRYINPUTACTIONMAPPINGS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Mappings",
                flags: MemberInfoFlags::new(144),
                field_type: INPUTCONCEPTTOENTRYINPUTACTIONMAPPINGSTRUCT_ARRAY_TYPE_INFO,
...
pub const INPUTCONCEPTTOENTRYINPUTACTIONMAPPINGS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputConceptToEntryInputActionMappings-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputConceptToEntryInputActionMappings-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTCONCEPTTOENTRYINPUTACTIONMAPPINGSTRUCT_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTCONCEPTTOENTRYINPUTACTIONMAPPINGSTRUCT_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputConceptToEntryInputActionMappingStruct-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputConceptToEntryInputActionMappingStruct-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEKEYS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEKEYS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDeviceKeys-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDeviceKeys-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const CURSORSTYLE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "CursorStyle",
    flags: MemberInfoFlags::new(49429),
    module: "InputShared",
    data: TypeInfoData::Enum,
...
pub const CURSORSTYLE_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "CursorStyle-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("CursorStyle-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEMOUSEBUTTONS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEMOUSEBUTTONS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDeviceMouseButtons-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDeviceMouseButtons-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEMOTIONCONTROLLERBUTTONS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEMOTIONCONTROLLERBUTTONS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDeviceMotionControllerButtons-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDeviceMotionControllerButtons-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEWHEELBUTTONS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEWHEELBUTTONS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDeviceWheelButtons-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDeviceWheelButtons-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEPADBUTTONS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEPADBUTTONS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDevicePadButtons-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDevicePadButtons-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTDEVICEAXES_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTDEVICEAXES_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputDeviceAxes-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputDeviceAxes-Array"),
    array_type: None,
    alignment: 8,
};
...
pub struct InputConfigurationAsset {
    pub default_input_graph: InputGraph,
    pub default_input_action_maps: InputActionMapsData,
    pub default_input_concept_to_entry_input_mappings: InputConceptToEntryInputActionMappings,
    pub entry_input_action_bindings: EntryInputActionBindingsData,
    ...
    pub input_settings: Vec<BaseInputSettings>,
}

pub const INPUTCONFIGURATIONASSET_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputConfigurationAsset",
    flags: MemberInfoFlags::new(101),
    module: "InputShared",
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                name: "InputSettings",
                flags: MemberInfoFlags::new(144),
                field_type: BASEINPUTSETTINGS_ARRAY_TYPE_INFO,
...
pub const INPUTCONFIGURATIONASSET_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputConfigurationAsset-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputConfigurationAsset-Array"),
    array_type: None,
    alignment: 8,
};
...
pub struct EditableActionMap {
    pub id: String,
    pub action_map: InputActionMapsData,
}

pub const EDITABLEACTIONMAP_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const EDITABLEACTIONMAP_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EditableActionMap-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EditableActionMap-Array"),
    array_type: None,
    alignment: 8,
};
...
pub struct InputActionMapsData {
    ...
    pub input_action_maps: Vec<InputActionMapData>,
    pub identifier: u32,
}

pub const INPUTACTIONMAPSDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                ...
                flags: MemberInfoFlags::new(0),
                field_type: INPUTACTIONMAPSLOT_TYPE_INFO,
                rust_offset: offset_of!(InputActionMapsData, default_input_action_map),
            },
            FieldInfoData {
                name: "InputActionMaps",
                flags: MemberInfoFlags::new(144),
                field_type: INPUTACTIONMAPDATA_ARRAY_TYPE_INFO,
...
pub const INPUTACTIONMAPSDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionMapsData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionMapsData-Array"),
    array_type: None,
    alignment: 8,
};
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Actions",
                flags: MemberInfoFlags::new(144),
                field_type: INPUTACTIONSDATA_ARRAY_TYPE_INFO,
                rust_offset: offset_of!(InputActionMapData, actions),
            },
            FieldInfoData {
                name: "PlatformSpecific",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTACTIONMAPPLATFORM_TYPE_INFO,
...
pub const INPUTACTIONMAPDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionMapData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionMapData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTACTIONSDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                name: "InputActions",
                flags: MemberInfoFlags::new(144),
                field_type: INPUTACTIONDATA_ARRAY_TYPE_INFO,
...
pub const INPUTACTIONSDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionsData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionsData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const MESSAGEINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const MESSAGEINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "MessageInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("MessageInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const MOUSEINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Button",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEMOUSEBUTTONS_TYPE_INFO,
...
pub const MOUSEINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "MouseInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("MouseInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const KEYBOARDINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Key",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEKEYS_TYPE_INFO,
...
pub const KEYBOARDINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "KeyboardInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("KeyboardInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const WHEELINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Button",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEWHEELBUTTONS_TYPE_INFO,
...
pub const WHEELINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "WheelInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("WheelInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const VRINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const VRINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "VrInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("VrInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const MOTIONCONTROLLERINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Button",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEMOTIONCONTROLLERBUTTONS_TYPE_INFO,
...
pub const MOTIONCONTROLLERINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "MotionControllerInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("MotionControllerInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const JOYSTICKINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                name: "Button",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEPADBUTTONS_TYPE_INFO,
...
pub const JOYSTICKINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "JoystickInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("JoystickInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const PADINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const PADINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "PadInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("PadInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const AXESINPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            FieldInfoData {
                name: "Axis",
                flags: MemberInfoFlags::new(0),
                field_type: INPUTDEVICEAXES_TYPE_INFO,
...
pub const AXESINPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "AxesInputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("AxesInputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTACTIONDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTACTIONDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTACTIONMAPSLOT_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTACTIONMAPSLOT_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionMapSlot-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionMapSlot-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const INPUTACTIONMAPPLATFORM_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const INPUTACTIONMAPPLATFORM_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "InputActionMapPlatform-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("InputActionMapPlatform-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const ENTRYINPUTACTIONBINDINGSDATA_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Class(ClassInfoData {
        ...
        fields: &[
            ...
            FieldInfoData {
                ...
                flags: MemberInfoFlags::new(144),
                field_type: ENTRYINPUTACTIONINDEXPAIR_ARRAY_TYPE_INFO,
...
pub const ENTRYINPUTACTIONBINDINGSDATA_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EntryInputActionBindingsData-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EntryInputActionBindingsData-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const ENTRYINPUTACTIONBINDING_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    ...
    data: TypeInfoData::Value(ValueTypeInfoData {
        fields: &[
            ...
            FieldInfoData {
                name: "ActionType",
                flags: MemberInfoFlags::new(0),
                field_type: ENTRYINPUTACTIONTYPE_TYPE_INFO,
...
pub const ENTRYINPUTACTIONBINDING_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EntryInputActionBinding-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EntryInputActionBinding-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const ENTRYINPUTACTIONTYPE_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const ENTRYINPUTACTIONTYPE_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EntryInputActionType-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EntryInputActionType-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const ENTRYINPUTACTIONINDEXPAIR_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const ENTRYINPUTACTIONINDEXPAIR_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "EntryInputActionIndexPair-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("EntryInputActionIndexPair-Array"),
    array_type: None,
    alignment: 8,
};
...
pub const BASEINPUTSETTINGS_TYPE_INFO: &'static TypeInfo = &TypeInfo {
...
pub const BASEINPUTSETTINGS_ARRAY_TYPE_INFO: &'static TypeInfo = &TypeInfo {
    name: "BaseInputSettings-Array",
    flags: MemberInfoFlags::new(145),
    module: "InputShared",
    data: TypeInfoData::Array("BaseInputSettings-Array"),
    array_type: None,
    alignment: 8,
};
